      ...
      <form className="data-form" onSubmit={submitForm}>
        ...
        <div className="group-2">
          <div className="form-group">
            ...
            <select onChange={inputHandler} value={formData.type_01} id="type_01" name="type_01">
          ...
          <div className="form-group">
            ...
            <select onChange={inputHandler} value={formData.type_02} id="type_02" name="type_02">
              <option value="null"></option>
              <option value="Type A">Type A</option>
              <option value="Type B">Type B</option>
              <option value="Type C">Type C</option>
          ...
          <div className="form-group">
            ...
            <select onChange={inputHandler} id="type_03" value={formData.type_03} name="type_03">
              <option value="null"></option>
              <option value="Type A">Type A</option>
              <option value="Type B">Type B</option>
              <option value="Type C">Type C</option>
        ...
        <div className="group-3">
          <div className="form-group">
            ...
            <select onChange={inputHandler} id="platform" value={formData.platform} name="platform">
              <option value="null"></option>
        ...
        <div className="group-7">
          ...
          <div className="form-group">
            ...
            <textarea value={formData.remarks} onChange={inputHandler} id="remarks" name="remarks"></textarea>
          </div>
        </div>
        <div className="form-group">
